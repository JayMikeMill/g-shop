...
const AdminProductsPage = lazy(
  () => import("@pages/admin/products-page/AdminProductsPage")
);
const AdminCatalogPageWrapper = lazy(
  () => import("@pages/admin/catalog-page/AdminCatalogPageWrapper")
);
...
const AdminCategoriesPage = lazy(() =>
  import("@pages/admin/catalog-page/AdminCatalogPage").then((mod) => ({
