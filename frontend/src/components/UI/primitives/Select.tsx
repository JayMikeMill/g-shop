...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      data-[placeholder]:text-muted-foreground transition-all
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        overflow-y-auto overflow-x-hidden rounded-md border bg-popover transition-all
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      py-1.5 pl-2 pr-8 text-sm outline-none transition-all
