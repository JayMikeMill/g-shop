import { type Address, type ShippingInfo } from "@shared/types/shipping-info";
...
export default function ShippingForm({
  ...
  return (
    <div className="surface-box max-w-2xl mx-auto my-8 p-lg  flex flex-col gap-md text-text font-sans">
